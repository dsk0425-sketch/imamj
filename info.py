...
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/+Y9NcU3DhpvY0YTc1'))
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002510131443').split()]
